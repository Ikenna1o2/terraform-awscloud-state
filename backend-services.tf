resource "aws_db_subnet_group" "vprofile-rds-subgrp" {
  name       = "main"
  subnet_ids = [module.vpc.private_subnets[0], module.vpc.private_subnets[1], module.vpc.private_subents[2]]
  tags = {
    Name = "Subenet group for RDS"
  }
}
...
resource "aws_elasticache_subnet_group" "vprofile-ecache-subgrp" {
  ...
  subnet_ids = [module.vpc.private_subnets[0], module.vpc.private_subnets[1], module.vpc.private_subents[2]]
  tags = {
    Name = "Subenet group for ECACHE"
  }
}

resource "aws-db-instance" "vprofile-rds" {
...
resource "aws_mqbroker" "vprofile-rmq" {
